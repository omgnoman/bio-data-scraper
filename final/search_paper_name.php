<?php
   ...
   $db= new MyDB();
    ...
    $outputs='';
      ...
      $results = $db->query("SELECT *FROM main_table INNER JOIN authors_table ON main_table.pubmed_id=authors_table.pubmed_id WHERE authors_table.fore_name LIKE '%".$search_title."%'");
