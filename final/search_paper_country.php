   ...
   $db= new MyDB();
    ...
    $outputs='';
      if (isset($_POST['query'])) {
           $search_title=$_POST['query'];
      $results = $db->query("SELECT *FROM main_table INNER JOIN authors_table ON main_table.pubmed_id=authors_table.pubmed_id  WHERE main_table.country_journal LIKE '%".$search_title."%'");
